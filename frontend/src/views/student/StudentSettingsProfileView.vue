...
<template>
  <div class="setting-page">
    <header class="head">
      <h1>个人资料</h1>
      <p>仅可修改与本人相关的信息，不包含学校和年级。</p>
      <div class="head-actions">
        <UserFeedbackButton context-label="学生-个人资料设置" />
      </div>
    </header>
    ...
    <section class="card">
      <div class="field-grid">
        ...
        <label class="field">
          <span>手机号</span>
          <input v-model="form.phone" type="text" inputmode="tel" placeholder="可选" />
        </label>
        <label class="field field-full">
          <span>头像地址</span>
          <input v-model="form.avatar_url" type="text" placeholder="可选：填入头像 URL" />
        </label>
      </div>
